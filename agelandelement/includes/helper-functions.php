...
function get_builder_image($url='',$class=''){
    ...
    function ageland_service_meta($opt)
    {
    ...
    function ageland_feature_meta($opt)
    {
    ...
    if ( 'section' === $element->get_name() && 'section_custom_css_pro' === $section_id ) {
        ...
        $element->start_controls_section(
            ...
            [
                ...
                'label' => __( 'Ageland Settings', 'ageland' ),
            ]
        );
        ...
        $element->add_control(
            'header_sticky',
            [
                'label'        =>   __( 'Sticky Section', 'ageland' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     =>   __( 'Yes', 'ageland' ),
                'label_off'    =>   __( 'No', 'ageland' ),
                'return_value' => 'ageland-sticky-header',
                'default'      => '',
                'prefix_class' => '',
            ]
        );
        $element->add_group_control(
            ...
            [
                ...
                'show_label' => true,
                'condition' => [
                    'header_sticky' => 'ageland-sticky-header'
                ],
                'selector' => '{{WRAPPER}}.ageland-sticky-header.sticky-on',
            ]
        );
        ...
        $element->add_responsive_control(
            '_element_width',
            [
                'label' => __( 'Width', 'ageland' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    '' => __( 'Default', 'ageland' ),
                    'inherit' => __( 'Full Width', 'ageland' ) . ' (100%)',
                    'auto' => __( 'Inline', 'ageland' ) . ' (auto)',
                    'initial' => __( 'Custom', 'ageland' ),
                ],
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => __( 'Vertical Align', 'ageland' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start' => [
                        'title' => __( 'Start', 'ageland' ),
        ...
        $element->add_control(
            ...
            [
                'raw' => '<strong>' . __( 'Please note!', 'ageland' ) . '</strong> ' . __( 'Custom positioning is not considered best practice for responsive web design and should not be used too frequently.', 'ageland' ),
        ...
        $element->add_control(
            '_position',
            [
                'label' => __( 'Position', 'ageland' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    '' => __( 'Default', 'ageland' ),
                    'absolute' => __( 'Absolute', 'ageland' ),
                    'fixed' => __( 'Fixed', 'ageland' ),
                ],
        ...
        $start = is_rtl() ? __( 'Right', 'ageland' ) : __( 'Left', 'ageland' );
        $end = ! is_rtl() ? __( 'Right', 'ageland' ) : __( 'Left', 'ageland' );

        $element->add_control(
            '_offset_orientation_h',
            [
                'label' => __( 'Horizontal Orientation', 'ageland' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'toggle' => false,
                'default' => 'start',
                'options' => [
        ...
        $element->add_control(
            ...
            [
                'label' => __( 'Vertical Orientation', 'ageland' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'toggle' => false,
                'default' => 'start',
                'options' => [
                    'start' => [
                        'title' => __( 'Top', 'ageland' ),
                        'icon' => 'eicon-v-align-top',
                    ],
                    'end' => [
                        'title' => __( 'Bottom', 'ageland' ),
                        'icon' => 'eicon-v-align-bottom',
                    ],
                ],
                'render_type' => 'ui',
...
add_action( 'elementor/element/heading/section_title_style/before_section_start', function( $element, $args ) {
    ...
    $element->add_control(
        'text_gra',
        [
            'label' => __( 'Text Gradient', 'ageland' ),
    ...
    $element->add_control(
        'text_transparent',
        [
            'label'        =>   __( 'Transparent', 'ageland' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'ageland' ),
            'label_off'    =>   __( 'No', 'ageland' ),
            'return_value' => 'ageland-text-gradient',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    $element->add_group_control(
        ...
        [
            ...
            'separator' => 'after',
            'condition' => [
                'text_transparent' => 'ageland-text-gradient'
            ],
            'selector' => '{{WRAPPER}}.ageland-text-gradient .elementor-heading-title',
        ]
    );
    $element->add_control(
        'text_sr',
        [
            'label' => __( 'Text Stroke', 'ageland' ),
            'type' => \Elementor\Controls_Manager::HEADING,
        ]
    );
    $element->add_control(
        'text_str',
        [
            'label'        =>   __( 'Turn On Stroke', 'ageland' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'ageland' ),
            'label_off'    =>   __( 'No', 'ageland' ),
            'return_value' => 'ageland-text-stroke',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    $element->add_control(
        's_fill_color',
        [
            'label' => __( 'Fill Color', 'ageland' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'condition' => [
                'text_str' => 'ageland-text-stroke'
            ],
            'selectors' => [
                '{{WRAPPER}}.ageland-text-stroke .elementor-heading-title' => '-webkit-text-fill-color: {{VALUE}}',
            ],
        ]
    );
    $element->add_responsive_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}}.ageland-text-stroke .elementor-heading-title' => '-webkit-text-stroke-width: {{SIZE}}{{UNIT}};',
            ],
            'condition' => [
                'text_str' => 'ageland-text-stroke'
            ],
    ...
    $element->add_control(
        's_text_color',
        [
            'label' => __( 'Stroke Color', 'ageland' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'condition' => [
                'text_str' => 'ageland-text-stroke'
            ],
            'selectors' => [
                '{{WRAPPER}}.ageland-text-stroke .elementor-heading-title' => '-webkit-text-stroke-color: {{VALUE}}',
            ],
        ]
    );
    $element->end_controls_section();
...
add_action( 'elementor/element/button/section_style/before_section_start', function( $element, $args ) {
    ...
    $element->start_controls_section(
        ...
        [
            'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            'label' => __( 'Ageland Settings', 'appilo' ),
        ]
    );
    $element->add_control(
        'btn_after',
        [
            'label'        =>   __( 'Turn On After', 'ageland' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'ageland' ),
            'label_off'    =>   __( 'No', 'ageland' ),
            'return_value' => 'ageland-button-after',
            'default'      => 'ageland-button-after-none',
            'prefix_class' => '',
        ]
    );
...
add_action( 'elementor/element/icon/section_style_icon/before_section_start', function( $element, $args ) {
    ...
    $element->add_control(
        'icon_light_box',
        [
            'label'        =>   __( 'Turn On LightBox', 'ageland' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'ageland' ),
            'label_off'    =>   __( 'No', 'ageland' ),
            'return_value' => 'ageland-icon-lightbox',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    $element->add_control(
        'icon_gradient',
        [
            'label'        =>   __( 'Turn On Gradient', 'ageland' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'ageland' ),
            'label_off'    =>   __( 'No', 'ageland' ),
            'return_value' => 'ageland-icon-gradient',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    ...
    $element->start_controls_tab(
        ...
        [
            'label' => __( 'Normal', 'appilo' ),
            'condition' => [
                'icon_gradient' => 'ageland-icon-gradient'
            ],
        ]
    );
    $element->add_control(
    ...
    $element->add_group_control(
        ...
        [
            ...
            'show_label' => true,
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.ageland-icon-gradient .elementor-icon i',
        ]
    );
    $element->add_control(
        'atext_gra',
    ...
    $element->add_group_control(
        ...
        [
            ...
            'show_label' => true,
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.ageland-icon-gradient .elementor-icon',
        ]
    );
    $element->end_controls_tab();
    ...
    $element->add_group_control(
        ...
        [
            ...
            'show_label' => true,
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.ageland-icon-gradient .elementor-icon:hover i',
        ]
    );
    $element->add_control(
        'afatext_gra',
    ...
    $element->add_group_control(
        ...
        [
            ...
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.ageland-icon-gradient .elementor-icon:hover',
        ]
    );
    $element->end_controls_tab();
...
function ageland_list_control($settings, $icon, $tag="li"){
    if(!empty($settings)){
...
function agelandelement_template_select() {
...
/*Meta Fields*/
function agelandelement_animations(){
    return array(
        '' => esc_html__('No animation', 'agelandelement') ,
        'reveal-top' => esc_html__('Animate from top', 'agelandelement') ,
        'reveal-bottom' => esc_html__('Animate from bottom', 'agelandelement') ,
        'reveal-left' => esc_html__('Animate from left', 'agelandelement') ,
        'reveal-right' => esc_html__('Animate from right', 'agelandelement') ,
    );  
}
...
function agelandelement_gird_column($column_size = '3') {
...
function agelandelement_gallery_column($column_size = 3) {
...
function ageland_page_title($arg){
        ...
        if ( is_category() ) {
          ...
          $title = esc_html__( 'Frontpage', 'ageland' );
        } elseif( is_singular() ){
          $title = get_the_title();
        }else {
            $title = esc_html__( 'Archives','ageland' );
        }
