...
function magnews_orderby_post(){
    return array(
        'none' => __('No order', 'agelandelement'),
        'ID' => __('Post ID', 'agelandelement'),
        'author' => __('Author', 'agelandelement'),
        'title' => __('Title', 'agelandelement'),
        'date' => __('Published date', 'agelandelement'),
        'modified' => __('Modified date', 'agelandelement'),
        'parent' => __('By parent', 'agelandelement'),
        'rand' => __('Random order', 'agelandelement'),
        'comment_count' => __('Comment count', 'agelandelement'),
        'menu_order' => __('Menu order', 'agelandelement'),
        'post__in' => __('By include order', 'agelandelement'),
    );  
}
...
function madmag_ft_images($thumbnail){
    ...
    $placeholder =  Ageland_PLUGIN_URL . 'assets/lazyload.svg';
...
function ageland_get_category_link($taxonomy){
...
function misha_loadmore_ajax_handler(){
    ...
    require Ageland_PLUGIN_DIR.'includes/loops/'. $template .'.php';
    die(); 
}
...
function misha_tabcat_ajax_handler(){
    ...
    //require(Ageland_PLUGIN_DIR.'includes/loops/tabcat.php');
    require Ageland_PLUGIN_DIR.'includes/loops/'. $template .'.php';
    die(); 
}
