...
class ageland_howwork extends Widget_Base {

    public function get_name() {
        return 'ageland-howwork';
    }
 
    public function get_title() {
        return __('How Work', 'ageland');
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                pellentesque etiam posuere. Gravida nunc id vulputate mauris amet, varius iuea er.', 'ageland' ),
            ]
        );
        $this->add_control(
            'work_list',
