 ...
 * @since 1.0.0
 */
class Widget_Ageland_logo extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Ageland Logo', 'ageland' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_image',
			[
				'label' => esc_html__( 'Site Logo', 'ageland' ),
			]
		);
		...
		$this->start_controls_section(
			'section_style_image',
			[
				'label' => esc_html__( 'Image', 'ageland' ),
		...
		$this->add_responsive_control(
			'width',
			[
				'label' => esc_html__( 'Width', 'ageland' ),
		...
		$this->add_responsive_control(
			'space',
			[
				'label' => esc_html__( 'Max Width', 'ageland' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'default' => [
					'unit' => '%',
				],
		...
		$this->add_responsive_control(
			'height',
			[
				'label' => esc_html__( 'Height', 'ageland' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'default' => [
					'unit' => 'px',
				],
		...
		$this->add_responsive_control(
			'object-fit',
			[
				'label' => esc_html__( 'Object Fit', 'ageland' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'condition' => [
					'height[size]!' => '',
				],
				'options' => [
					'' => esc_html__( 'Default', 'ageland' ),
					'fill' => esc_html__( 'Fill', 'ageland' ),
					'cover' => esc_html__( 'Cover', 'ageland' ),
					'contain' => esc_html__( 'Contain', 'ageland' ),
				],
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_tab( 'normal',
			[
				'label' => esc_html__( 'Normal', 'ageland' ),
			]
		);
		...
		$this->add_control(
			'opacity',
			[
				'label' => esc_html__( 'Opacity', 'ageland' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 1,
		...
		$this->start_controls_tab( 'hover',
			[
				'label' => esc_html__( 'Hover', 'ageland' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Transition Duration', 'ageland' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 3,
		...
		$this->add_control(
			'hover_animation',
			[
				'label' => esc_html__( 'Hover Animation', 'ageland' ),
		...
		$this->add_responsive_control(
			'image_border_radius',
			[
				'label' => esc_html__( 'Border Radius', 'ageland' ),
