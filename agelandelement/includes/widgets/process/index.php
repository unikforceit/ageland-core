...
class ageland_process extends Widget_Base {

    public function get_name() {
        return 'ageland-process';
    }
 
    public function get_title() {
        return __('Process', 'ageland');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'How It Works', 'ageland' ),
            ]
        );
        $this->add_control(
            'info',
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => __( 'Task Collaboration', 'ageland' ),
            ]
        );
        $repeater->add_control(
            'w_info',
            [
                'label' => __( 'Work Info', 'ageland' ),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pretium dapibus nisl,
                 ...
                 Nam potenti commodo tempus, laoreet scelerisque id nisl. Urna urna, commodo metus', 'ageland' ),
            ]
        );
        $repeater->add_control(
            'w_image',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'w_title' => __( 'Task Collaboration', 'ageland' ),
                    ],
                    [
                        'w_title' => __( 'Task Collaboration', 'ageland' ),
                    ],
...
Plugin::instance()->widgets_manager->register_widget_type( new ageland_process() );