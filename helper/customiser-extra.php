...
class ageland_plugins_hooks {

    function __construct() {
        add_action('upload_mimes',array(&$this,'ageland_mime_type'));
    ...
    function ageland_render_sidebar(){
        ...
        $cust_header = ageland_options('sidebar');
    ...
    function ageland_render_footer(){
        ...
        $meta_switch = ageland_meta('footer_switch');
        $meta_footer = ageland_meta('meta_footer');
    ...
    function ageland_render_header(){
        $meta_switch = ageland_meta('header_switch');
        $meta_header = ageland_meta('meta_header');
    ...
    function ageland_share_tag(){
        ...
        $tagtitle = ageland_options('tag_title');
        $sharetitle = ageland_options('share_title');
    ...
    function ageland_authorbox(){
        ...
        $title = ageland_options('auth_title');
    ...
    function ageland_related_post(){
        $title = ageland_options('related_title');
        $id = $GLOBALS['post']->ID;
    ...
    function ageland_bar_plugin_scripts() {
        ...
        function dynamic_css() {
            ob_start();
            include AGELAND_PLUG_DIR . '/vendor/frontend/css.php';
    ...
    function ageland_mime_type($mimes) {
