...
function ae_plugin_page_setup( $default_settings ) {
    ...
    $default_settings['page_title']  = esc_html__( 'Demo Importer' , 'ageland' );
    $default_settings['menu_title']  = esc_html__( 'Demo Importer' , 'ageland' );
...
function ageland_mime_types($mimes) {
    $mimes['svg'] = 'image/svg+xml';
    return $mimes;
}
add_filter('upload_mimes','ageland_mime_types');
